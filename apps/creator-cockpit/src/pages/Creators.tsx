      ...
      <div className="premium-card overflow-hidden rounded-lg">
        ...
        <div className="divide-y divide-blue-500/12">
          {creators.map((creator) => (
            <div key={creator.id} className="grid grid-cols-[1.4fr_0.8fr_0.8fr_0.9fr] items-center gap-3 px-4 py-3">
              ...
              <div className="text-sm text-blue-100/66">{formatDate(creator.last_sync_at)}</div>
